...
main (void)
{
  ...
  // set up values in msu_parameters structure
  my_coefficients.a = 2.;
  my_coefficients.b = 3./2.;

  params_ptr = &my_coefficients;
  ofstream out ("test_derivative_test.dat");	// open the output file
...
test_function (double x, void *params_ptr)
{
  ...
  double alpha = ((msu_parameters *) params_ptr)->a;
  double beta = ((msu_parameters *) params_ptr)->b;
